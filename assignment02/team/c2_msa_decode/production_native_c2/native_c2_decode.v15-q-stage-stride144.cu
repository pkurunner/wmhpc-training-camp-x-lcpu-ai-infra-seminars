...
// v15 changes only the leading dimension of the shared Q tile.  A 144-BF16
// stride is WMMA-legal (a multiple of eight elements) and rotates each
// successive row by eight 32-bit shared-memory banks.
constexpr int kQTileStride = kHeadDim + 16;

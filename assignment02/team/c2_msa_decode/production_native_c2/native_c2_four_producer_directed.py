#!/usr/bin/env python3
"""Directed liveness/correctness tests for the four-producer C2 candidate.
...
incorrect four-way LSE merge cannot hide in random data.
"""
...
def _run(args: argparse.Namespace) -> dict[str, object]:
    ...
    return {
        ...
        ) and bool(all_invalid["all_gates_pass"]),
        ...
        "schema": "c2-native-c2-four-producer-directed-v1",

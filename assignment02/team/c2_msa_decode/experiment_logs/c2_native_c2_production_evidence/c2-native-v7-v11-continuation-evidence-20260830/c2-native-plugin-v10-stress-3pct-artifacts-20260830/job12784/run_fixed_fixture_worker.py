...
def load_base(path: Path):
    spec = importlib.util.spec_from_file_location("c2_v10_worker_base", path)
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if fixture.get("schema") != "c2-native-v10-k-prefetch-fixed-fixtures-v1":
    ...
    return {
        "schema": "c2-native-plugin-v10-k-prefetch-fixed-fixture-worker-v1", "role": args.role,
...
def main() -> int:
    ...
    try:
        ...
        payload = {"schema": "c2-native-plugin-v10-k-prefetch-fixed-fixture-worker-v1", "role": args.role,
